...
export function RegisterForm() {
  ...
  const getPasswordStrength = () => {
    ...
    if (pwd.length < 6) return { text: 'Weak', color: 'text-red-600', bg: 'bg-red-100' };
    if (pwd.length < 8) return { text: 'Fair', color: 'text-yellow-600', bg: 'bg-yellow-100' };
  ...
  return (
    <Card className="border-0 shadow-xl max-w-md mx-auto">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>
          Sign up to start booking your ferry trips
        </CardDescription>
      </CardHeader>
      <CardContent>
        {displayError && (
          ...
          <div className="space-y-2">
            ...
            {strength && (
              <div className="flex items-center gap-2 mt-1">
                <div className={`h-1.5 flex-1 rounded-full ${strength.bg}`} />
